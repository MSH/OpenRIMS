...
public enum MonthPersian
{
    ...
    final static String[] PERSIAN_MONTHS_EN = {"Hamal", "Sawr", "Jawza", "Saratan", "Asad", "Sunbula", "Mizan", "'Aqrab", "Qaws", "Jaddi", "Dalwa", "Hout"};
   // final static String[] PERSIAN_MONTHS_FA = {"فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور", "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند"};
    final static String[] PERSIAN_MONTHS_FA = {"الميزان", "العقرب", "القوس", 	"الجدي",	"الدلو", "الحوت", "الحمل", "الثور", "الجوزاء", "السرطان", 	"الأسد", "السنبلة"};
