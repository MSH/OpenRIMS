...
class Inns extends Component{
    ...
    eventProcessor(event){
        ...
        if(data.from==this.props.recipient){
            /*if(data.subject=="onInnChange"){
                console.log("onInnChange")
            }*/
        }
        return
    }
    ...
    tableLoader(){
        Fetchers.postJSONNoSpinner("/api/common/inn/load/table", this.state.data, (query, result)=>{
    ...
    selectRow(rowNumber){
        ...
        if(!isdublicate){
            ...
            this.state.data.product_innname.value = row.row[0].value
    ...
    deselectRow(rowNumber){
        ...
        Navigator.message(this.state.identifier, this.props.recipient, "onInnChange",this.state.data)
        this.setState(this.state.data)
    }
                        ...
                        <Col xs='12' sm='12' lg='6' xl='6'>
                            ...
                            <Row hidden={!this.state.showform} className={Pharmadex.settings.activeBorder}>
                                <Col xs='12' sm='12' lg='12' xl='12'>
                                    <Row>
                                        <Col xs='12' sm='12' lg='12' xl='12'>
                                            <h6>{this.state.data.product_innname.value}</h6>
                                        </Col>
                                    </Row>
                                    <Row>
                                    ...
                                    <Row>
                                        ...
                                        <Col xs='12' sm='12' lg='4' xl='4'>
                                            <ButtonUni
                                                ...
                                                color='primary'
                                                onClick={()=>{
                                                    Fetchers.postJSONNoSpinner("/api/common/inn/add", this.state.data,(query,result)=>{
                                                        this.state.data=result
                                        ...
                                        <Col xs='12' sm='12' lg='4' xl='4'>
                                            <ButtonUni
                                                    ...
                                                    onClick={()=>{
                                                        ...
                                                        this.state.data.product_innname.value = ""
                                                        this.state.data.dos_strength.value = ""
                                                        this.state.data.dos_unit.value = ""
                                                        this.setState(this.state)
                                                    }}/>
