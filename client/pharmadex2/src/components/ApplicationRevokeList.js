...
/**
 * List of applications in revoke state
 */
class ApplicationRevokeList extends Component{
    constructor(props){
        super(props)
        this.state={
     ...
     */
    loadTable(){
        Fetchers.postJSON("/api/"+Navigator.tabSetName()+"/applications/revokes", this.state.data, (query,result)=>{
        ...
        return(
            <Container fluid className={Pharmadex.settings.activeBorder}>
                <Row className="mt-1 mb-3">
                    <Col>
                        <h6>{this.state.labels.revokeapplications}</h6>
                    </Col>
                </Row>
                <Row>
...
export default ApplicationRevokeList
ApplicationRevokeList.propTypes={
