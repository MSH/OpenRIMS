...
class DataVarForm extends Component{
     ...
     */
    loadData(){
        Fetchers.postJSON("/api/admin/data/configuration/variable/load", this.state.data, (query,result)=>{
                    ...
                    <Row>
                        ...
                        <Col xs='12' sm='12' lg='3' xl='3'>
                            <ButtonUni
                                ...
                                onClick={()=>{
                                    Pharmadex.wait()
                                    Fetchers.postJSON("/api/admin/data/configuration/variable/save", this.state.data, (query,result)=>{
                                        this.state.data=result
                                        if(result.valid){
    ...
    render(){
        ...
        return(
            <Container fluid className={Pharmadex.settings.activeBorder}>
                ...
                <Row>
                    <Col>
                        <ViewEditOption attribute="publicavailable" component={this} edit />
                    </Col>
                    <Col>
