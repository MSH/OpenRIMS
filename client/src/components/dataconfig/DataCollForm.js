...
class DataCollForm extends Component{
     ...
     */
    loadData(){
        Fetchers.postJSON("/api/admin/data/collection/definition/load", this.state.data, (query,result)=>{
                    ...
                    <ButtonUni
                        ...
                        onClick={()=>{
                            Fetchers.alerts(this.state.labels.warningRemove, ()=>{
                                Fetchers.postJSON("/api/admin/data/collection/definition/suspend", this.state.data, (query,result)=>{
                                    Navigator.message(this.state.identifier, this.props.recipient,"formCollCancel",{})
                                })     
                            }, null)
                        }}
