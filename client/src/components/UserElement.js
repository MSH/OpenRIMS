...
class UserElement extends Component{
    ...
    loadData(){
        ...
        Fetchers.postJSON("/api/admin/user/load", this.state.data, (query, result)=>{
            ...
            <Row className="mb-2">
                  ...
                  <Col xs='12' sm='12' lg='2' xl='2'>
                    <ButtonUni
                         ...
                         onClick={()=>{
                            Fetchers.postJSON("/api/admin/user/save", this.state.data,(query,result)=>{
                                Fetchers.setJustLoaded(result,false)
                                if(result.valid){
                    ...
                    <ButtonUni
                         ...
                         onClick={()=>{
                            Fetchers.alerts(this.state.labels.warningRemove, ()=>{
                                Fetchers.postJSON("/api/admin/user/suspend", this.state.data, (query, result)=>{
                                    Fetchers.setJustLoaded(result,false)
                                    this.state.data=result
                                    this.setState(this.state)
                                    let caller=this.props.caller
