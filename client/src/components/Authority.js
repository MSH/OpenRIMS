...
class Authority extends Component{
    ...
    componentDidMount(){
        ...
        Fetchers.postJSON("/api/admin/organization/load", this.state.data,(query,result)=>{
            ...
            <Row>
                ...
                <Col xs='12' sm='12' lg='2' xl='2'>
                    <ButtonUni
                            ...
                            onClick={()=>{
                                Fetchers.postJSON("/api/admin/organization/save", this.state.data,(query,result)=>{
                                    if(result.valid){
                    ...
                    <ButtonUni
                            ...
                            onClick={()=>{
                                Fetchers.alerts(this.state.labels.warningRemove, ()=>{
                                    Fetchers.postJSON("/api/admin/organization/suspend", this.state.data,(query,result)=>{
     ...
     */
    loadTable(){
        Fetchers.postJSON("/api/admin/organization/load/responsibility", this.state.data,(query,result)=>{
            Fetchers.setJustLoaded(result,false)
            this.state.data=result;
            this.setState(this.state)
        })
